...
assert.ok(index.includes('growth-db.js?v=1.19.1-b58'),'growth DB script missing');
assert.ok(index.includes('growth-model.js?v=1.19.1-b58'),'growth model script missing');
assert.ok(index.includes('growth-core.js?v=1.19.1-b58'),'growth core script missing');
assert.ok(index.includes('growth-ui.js?v=1.19.1-b58'),'growth UI script missing');
assert.ok(index.indexOf('growth-db.js?v=1.19.1-b58')<index.indexOf('app.js?v=1.19.1-b58'),'growth DB must load before app initialization');
assert.ok(index.indexOf('growth-model.js?v=1.19.1-b58')<index.indexOf('growth-core.js?v=1.19.1-b58'),'growth model must load before growth core');
assert.ok(index.indexOf('ui-refresh.js?v=1.19.1-b58')<index.indexOf('growth-ui.js?v=1.19.1-b58'),'growth UI must load after existing UI refresh');
