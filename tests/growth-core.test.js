...
const inferredLate8=model.inferCandidates({entryMonth:8,growthComment:'晩成コメントあり'});
assert.deepStrictEqual(inferredLate8.candidates,['晩成']);
assert.strictEqual(inferredLate8.confidence,'中');
