...
console.log(JSON.stringify({
  ...
  contract:{
    ...
    sale:'main production axis uses mare-aware rerank; each card shows role/reason before details',
    breed:'same mare-aware production comparison and reason cues',
