...
need(v27,"quickGoalCell('arc','凱旋門賞'",'quick purpose cards must start with Arc');
need(v27,"quickGoalCell('bc','BC長期'",'quick purpose cards must keep BC second');
if(v27.indexOf("quickGoalCell('arc','凱旋門賞'")>v27.indexOf("quickGoalCell('bc','BC長期'"))throw Error('quick purpose order must remain Arc then BC');
