...
need(idx,'v28.js?v=1.19.1-b52','v28 cache wiring');
if(!(idx.indexOf('breed-integration.js?v=1.19.1-b52')<idx.indexOf('v28.js?v=1.19.1-b52')))throw Error('v28 must load after breed integration');
if(!(idx.indexOf('v27.js?v=1.19.1-b52')<idx.indexOf('v28.js?v=1.19.1-b52')))throw Error('v28 must load after v27');
