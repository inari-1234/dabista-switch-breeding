...
need(idx,'v28.js?v=1.19.1-b54','v28 cache wiring');
if(!(idx.indexOf('breed-integration.js?v=1.19.1-b54')<idx.indexOf('v28.js?v=1.19.1-b54')))throw Error('v28 must load after breed integration');
if(!(idx.indexOf('v27.js?v=1.19.1-b54')<idx.indexOf('v28.js?v=1.19.1-b54')))throw Error('v28 must load after v27');
