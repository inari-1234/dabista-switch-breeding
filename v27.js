...
function style(){
 ...
 #saleGoalButtons button{display:flex;align-items:center;justify-content:center;gap:5px}
 #saleGoalButtons button span{font:inherit}
 #saleGoalButtons button small{display:inline-grid;place-items:center;min-width:28px;padding:2px 5px;border-radius:999px;background:rgba(34,91,67,.08);font-size:8px;font-weight:900;color:#53675e}
 #saleGoalButtons button.on small{background:rgba(255,255,255,.2);color:inherit}
 .purpose-focus{margin-top:9px;padding:11px;border-radius:12px;background:rgba(255,255,255,.84);border:1px solid rgba(70,105,88,.14)}
 .purpose-focus-head{display:flex;justify-content:space-between;gap:10px;align-items:flex-start}
 .purpose-focus-head small{display:block;font-size:8px;font-weight:900;color:#687970}.purpose-focus-head h3{margin:2px 0 0;font-size:15px;color:#174b37}
 ...
 .mare-factor-row{margin-top:8px;padding:8px 9px;border-radius:9px;background:#f7faf8;border:1px solid rgba(80,110,95,.10)}.mare-factor-row>small{display:block;font-size:8px;font-weight:900;color:#687970;margin-bottom:5px}.mare-factor-row>div{display:grid;gap:4px}.mare-factor-row>div>span{display:flex;align-items:center;gap:5px;flex-wrap:wrap;font-size:8px;color:#4f6359}.mare-factor-row>div>span>b{min-width:24px;color:#254b39}.factor-chips{display:inline-flex;gap:3px;flex-wrap:wrap}.factor-chips i{font-style:normal;padding:2px 4px;border-radius:999px;background:#fbe7ef;color:#9b2e63;font-size:7px;font-weight:900}.factor-chips i.compact{font-size:7px}
 .purpose-attention{margin-top:8px}.purpose-attention>small{display:block;font-size:8px;font-weight:900;color:#687970;margin-bottom:5px}
 .purpose-actions{display:grid;grid-template-columns:1.6fr 1fr;gap:7px;margin-top:10px}.purpose-actions button{min-height:46px;font-size:10px;font-weight:900}
 .mare-purpose-dialog{width:min(760px,calc(100vw - 14px));max-height:94dvh;border:0;border-radius:18px;padding:0;overflow:hidden}.purpose-dialog-head{display:flex;justify-content:space-between;gap:10px;align-items:center;padding:13px 14px 10px;background:#fff;border-bottom:1px solid #e1e8e4}.purpose-dialog-head small{font-size:8px;font-weight:900;color:#697970}.purpose-dialog-head h2{margin:2px 0 0;font-size:18px}.purpose-dialog-body{max-height:calc(94dvh - 126px);overflow:auto;-webkit-overflow-scrolling:touch;padding:12px 14px 18px}.purpose-dialog-actions{display:grid;grid-template-columns:1fr auto;gap:8px;padding:10px 14px calc(10px + env(safe-area-inset-bottom));border-top:1px solid #e1e8e4;background:#fff}
 .pedigree-meta{display:flex;gap:7px;flex-wrap:wrap;margin-bottom:9px}.pedigree-meta span{padding:5px 7px;border-radius:999px;background:#eef4f0;font-size:8px;color:#5c6e65}.pedigree-scroll{overflow:auto;padding-bottom:4px}.pedigree-tree{display:grid;grid-template-columns:140px 150px 160px 170px;gap:5px;min-width:650px;height:430px}.pedigree-col{display:grid;grid-template-rows:repeat(8,1fr);gap:4px}.pedigree-cell{display:flex;flex-direction:column;justify-content:center;min-height:0;padding:5px 7px;border:1px solid #dfe8e3;border-radius:8px;background:#fff}.pedigree-cell b{font-size:9px;line-height:1.2}.pedigree-cell .factor-chips{margin-top:3px}.pedigree-cell.focus-sire,.pedigree-cell.focus-siresire,.pedigree-cell.focus-damsire{border-color:#8bbca4;background:#f1f8f4}.pedigree-systems{margin-top:10px;padding:9px 10px;border-radius:10px;background:#f5f8f6}.pedigree-systems small{display:block;font-size:8px;font-weight:900;color:#65766e}.pedigree-systems b{display:block;margin-top:2px;font-size:11px}.pedigree-systems span{display:block;margin-top:4px;font-size:8px;line-height:1.45;color:#6a7871}
 .sim-rank{display:grid;grid-template-columns:auto auto 1fr;gap:8px;align-items:center;padding:9px 10px;border-radius:10px;background:#fff5df}.sim-rank small{font-size:8px;font-weight:900;color:#7a641e}.sim-rank b{font-size:18px;color:#b34a2f}.sim-rank span{font-size:8px;line-height:1.4;color:#6c6250}
 .sim-pair{margin-top:10px;padding:10px;border-radius:11px;border:1px solid #cfe0d7;background:#f8fbf9}.sim-pair small{display:block;font-size:8px;font-weight:900;color:#60736a}.sim-pair>div{display:grid;grid-template-columns:1fr auto 1fr;gap:8px;align-items:center;margin-top:6px}.sim-pair b{font-size:13px;color:#174b37}.sim-pair b:last-child{text-align:right}.sim-pair span{font-size:16px;color:#728078}
 .sim-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-top:8px}.sim-grid>div{padding:8px;border-radius:9px;background:#f4f7f5;text-align:center}.sim-grid small{display:block;font-size:8px;color:#687970}.sim-grid b{display:block;margin-top:2px;font-size:16px;color:#214c38}
 .sim-evidence,.sim-operate{margin-top:9px;padding:10px;border-radius:10px;background:#f7faf8;border:1px solid rgba(80,110,95,.10)}.sim-evidence>b,.sim-operate>b{display:block;font-size:10px;color:#254b39}.sim-evidence>span{display:block;margin-top:4px;font-size:9px;line-height:1.5;color:#60736a}.sim-evidence .candidate-chip-row{margin-top:7px}.sim-operate ol{margin:6px 0 0;padding-left:18px;font-size:9px;line-height:1.55;color:#53675e}.sim-tech{margin-top:9px}.sim-tech summary{font-size:9px;font-weight:900;color:#5b6e65}.sim-tech div{margin-top:5px;font-size:8px;color:#687970}
