(()=>{
'use strict';
const V=window.APP_VERSION||'1.19.1',BUILD=window.APP_BUILD||'2026.09.27-70',db=window.db,$=s=>document.querySelector(s),esc=window.esc||((s)=>String(s??'')),lifecycle=window.DABISTA_HORSE_LIFECYCLE;
