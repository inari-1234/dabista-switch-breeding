...
function ensureStyle(){
 ...
 #horseUseDlg{width:min(680px,calc(100vw - 24px));max-height:88vh}
 ...
 @media(max-width:520px){.horse-use-goal{grid-template-columns:1fr}.horse-match-head{align-items:center}}
